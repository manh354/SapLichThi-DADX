namespace SapLichThiAlgorithm.Extensions
{
    public static class ArrayExtension
    {
        ...
        public static void WriteArrayToFile(this float[,] array, string name)
        {
            string path = $"Outputs/Test/{name}.txt";
            Directory.CreateDirectory($"Outputs/Test");
        ...
        public static void WriteArrayToFile2(this float[,] array, string name)
        {
            string path = $"Outputs/Test2/{name}.txt";
            Directory.CreateDirectory($"Outputs/Test2");
